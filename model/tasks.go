...
var TaskWhere = struct {
	...
	Completed:   whereHelpernull_Bool{field: "`tasks`.`completed`"},
...
var (
	taskAllColumns            = []string{"id", "title", "description", "completed", "user_id"}
	taskColumnsWithoutDefault = []string{"title", "description", "user_id"}
	taskColumnsWithDefault    = []string{"id", "completed"}
